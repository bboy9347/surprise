...
import { allImages } from '../assets/gallery';
...
class App {
  constructor(container, { items, bend, textColor = "#ffffff", borderRadius = 0, font = "bold 30px DM Sans" } = {}) {
    ...
    this.onResize()
    this.createGeometry()
    this.createMedias(allImages, bend, textColor, borderRadius, font)
    this.update()
...
export default function CircularGallery({
  ...
  useEffect(() => {
    const app = new App(containerRef.current, { bend, textColor, borderRadius, font })
    return () => {
      app.destroy()
    }
